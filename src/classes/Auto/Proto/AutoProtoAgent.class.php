 ...
 *****************************************************************************/
	...
	abstract class AutoProtoAgent extends ProtoPerson
	{
		protected function makePropertyList()
		{
			return
				array_merge(
					...
					array(
						'id' => LightMetaProperty::fill(new LightMetaProperty(), 'id', null, 'integerIdentifier', 'Agent', 8, true, true, false, null, null),
