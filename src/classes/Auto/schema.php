 ...
 *****************************************************************************/
	...
	// country_i18n.object_id -> country.id
	$schema->
		getTableByName('country_i18n')->
		getColumnByName('object_id')->
		setReference(
			$schema->
				getTableByName('country')->
				getColumnByName('id'),
				ForeignChangeAction::restrict(),
				ForeignChangeAction::cascade()
			);
	
	// country_i18n.language_id -> language.id
	$schema->
		getTableByName('country_i18n')->
		getColumnByName('language_id')->
		setReference(
	...
	// region_i18n.object_id -> region.id
	$schema->
		getTableByName('region_i18n')->
		getColumnByName('object_id')->
		setReference(
			$schema->
	...
	// region_i18n.language_id -> language.id
	$schema->
		getTableByName('region_i18n')->
		getColumnByName('language_id')->
		setReference(
	...
	// custom_item.article_id -> article.id
	$schema->
		getTableByName('custom_item')->
