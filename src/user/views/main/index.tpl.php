		...
		<div class="container main">
			<div class="row">
				...
				<div class="span4">
					...
					<h4 class="visible-desktop">Some search Criteria:</h4>
					...
					<div class="row-fluid">
						<div class="span4">
							<div class="control-group">
								<label class="control-label" for="input_realtyType">Area / bedrooms</label>
								<div class="controls">
									<select type="text" class="input-block-level">
										<option>Choose ...</option>
										<option>1</option>
						...
						<div class="span4">
							<div class="control-group">
								<label class="control-label" for="input_city">Toylets</label>
								<div class="controls">
									<select type="text" class="input-block-level">
										<option>Choose ...</option>
										<option>1</option>
