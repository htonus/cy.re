...
CREATE TABLE "realty_type_i18n" (
    "id" BIGINT NOT NULL default nextval('realty_type_i18n_id'),
    "object_id" BIGINT NOT NULL REFERENCES "realty_type"("id") ON UPDATE CASCADE ON DELETE CASCADE,
    "language_id" BIGINT NOT NULL REFERENCES "language"("id") ON UPDATE CASCADE ON DELETE CASCADE,
    "name" CHARACTER VARYING(16) NOT NULL,
    PRIMARY KEY("id")
);
...
CREATE TABLE "realty" (
    ...
    "type_id" BIGINT NOT NULL REFERENCES "realty_type"("id") ON UPDATE CASCADE ON DELETE RESTRICT,
    "offer_id" BIGINT NOT NULL REFERENCES "offer_type"("id") ON UPDATE CASCADE ON DELETE RESTRICT,
