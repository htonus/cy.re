...
CREATE SEQUENCE "unit_i18n_id" START WITH 10;
...
insert into "unit" ("id", "name", "sign") values (2, 'quantity', '');
insert into "unit" ("id", "name", "sign") values (3, 'flag', '');	-- all internal options
insert into "unit_i18n" ("object_id", "language_id", "name") select "id", 1, "name" from "unit";


CREATE SEQUENCE "city_id";
CREATE TABLE "city" START WITH 10 (
    "id" INTEGER NOT NULL default nextval('unit_id'),
    "name" CHARACTER VARYING(16) NULL,
